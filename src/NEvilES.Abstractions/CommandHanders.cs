...
namespace NEvilES.Abstractions
{
    ...
    {
        ICommandResponse Handle(TCommand command, TDep1 dep1);
    }
    ...
    {
        ICommandResponse Handle(TCommand command, TDep1 dep1, TDep2 dep2);
    }
    ...
    {
        ICommandResponse Handle(TCommand command, TDep1 dep1, TDep2 dep2, TDep3 dep3);
    }
    ...
    {
        ICommandResponse Handle(TCommand command, TDep1 dep1, TDep2 dep2, TDep3 dep3, TDep4 dep4);
    }
